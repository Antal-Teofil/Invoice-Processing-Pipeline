...
export const ItemFormSchema = z.object({
    ...
    classifiedTaxCategory: TaxCategoryFormSchema.nullable().default(null),
    additionalItemProperty: z.array(AdditionalItemPropertyFormSchema).nullable().default(null)
});